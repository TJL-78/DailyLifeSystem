...
const I18N = {
  zh: {
    ...
    // Health & Life
    healthLifeSection: '健康生活',
    sleepNav: '睡眠', sleepTitle: '睡眠记录', addSleepRecord: '添加睡眠记录',
    sleepTimePh: '入睡时间', wakeTimePh: '起床时间', sleepQuality: '质量',
    avgSleepHours: '平均睡眠(h)', avgQuality: '平均质量', totalRecords: '记录总数',
    sleepTrend: '睡眠趋势（近14天）', sleepHistory: '历史记录', noSleepRecords: '暂无睡眠记录',
    moodNav: '心情', moodTitle: '心情追踪', addMoodRecord: '记录心情',
    energyLevel: '精力值', moodCalendar: '心情日历（近30天）',
    mostFrequentMood: '最常见心情', avgEnergy: '平均精力', moodHistory: '心情记录', noMoodRecords: '暂无心情记录',
    healthNav: '运动健康', healthTitle: '运动与健康', addHealthRecord: '添加记录',
    exerciseType: '运动类型', running: '跑步', walking: '步行', gym: '健身',
    yoga: '瑜伽', cycling: '骑行', swimming: '游泳', otherExercise: '其他',
    exerciseMinPh: '时长(分)', waterIntake: '饮水量', waterProgress: '饮水进度',
    stepsPlaceholder: '步数', weightPlaceholder: '体重(kg)', notePlaceholder: '备注',
    todayExerciseMin: '今日运动(分)', todayWaterMl: '今日饮水(ml)', todaySteps: '今日步数',
    healthHistory: '历史记录', noHealthRecords: '暂无健康记录',
    financeNav: '记账', financeTitle: '简单记账', addFinanceRecord: '添加记录',
  ...
  en: {
    ...
    // Health & Life
    healthLifeSection: 'Health & Life',
    sleepNav: 'Sleep', sleepTitle: 'Sleep Tracker', addSleepRecord: 'Add Sleep Record',
    sleepTimePh: 'Bedtime', wakeTimePh: 'Wake time', sleepQuality: 'Quality',
    avgSleepHours: 'Avg Sleep (h)', avgQuality: 'Avg Quality', totalRecords: 'Total Records',
    sleepTrend: 'Sleep Trend (14 days)', sleepHistory: 'History', noSleepRecords: 'No sleep records yet',
    moodNav: 'Mood', moodTitle: 'Mood Tracker', addMoodRecord: 'Log Mood',
    energyLevel: 'Energy', moodCalendar: 'Mood Calendar (30 days)',
    mostFrequentMood: 'Most Frequent', avgEnergy: 'Avg Energy', moodHistory: 'Mood History', noMoodRecords: 'No mood records yet',
    healthNav: 'Health', healthTitle: 'Exercise & Health', addHealthRecord: 'Add Record',
    exerciseType: 'Exercise type', running: 'Running', walking: 'Walking', gym: 'Gym',
    yoga: 'Yoga', cycling: 'Cycling', swimming: 'Swimming', otherExercise: 'Other',
    exerciseMinPh: 'Duration (min)', waterIntake: 'Water', waterProgress: 'Water Progress',
    stepsPlaceholder: 'Steps', weightPlaceholder: 'Weight (kg)', notePlaceholder: 'Note',
    todayExerciseMin: 'Exercise (min)', todayWaterMl: 'Water (ml)', todaySteps: 'Steps',
    healthHistory: 'History', noHealthRecords: 'No health records yet',
    financeNav: 'Finance', financeTitle: 'Simple Finance', addFinanceRecord: 'Add Record',
